#ifndef _SG_VERTEXFORMAT_H
#define _SG_VERTEXFORMAT_H
...
{
public:
	/** Constants related to vertex format. */
	enum Constants
	{ 
		/** Max number of texture coordinate layers. */
		MAX_LAYERS = 4 
	};
	...
	/** Marks format to be used only with shaders. */
	VertexFormat&	setShaderEnabled();
	...
	/** Returns string description about the format. */
